...
flags.DEFINE_string('measurement_type', 'drop_independent', 'name of experiment')
...
flags.DEFINE_float("blur_radius", 0.1, "the init of learn rate")
flags.DEFINE_float("additive_noise_std", 0.0, "the init of learn rate")
...
flags.DEFINE_integer("patch_size", 10, "the init of learn rate")
flags.DEFINE_integer("blur_filter_size", 1, "the init of learn rate")
